...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="row mb-20">
            ...
            <div class="col-md-9" style="float:left; width: 100%; background-color: white; border-radius:10px; box-shadow: 0px 0px 11px 0px rgba(0,0,0,0.15) !important;">
                ...
                <div class="row" style="padding: 1.25rem 1.25rem 0rem 1.25rem">
                    <div class="col-md-12 p0">
                        <h3 class="card_pagos_titulo bold" style="width: 75% !important;">Informe de obra</h3>
                ...
                <div class="row" style="padding: 1.25rem 1.25rem 0rem 1.25rem">
                    <div class="col-md-12 d_f_row pl0" style="align-items:center;">
            ...
            <div class="col-md-2 cards-informes">
                <div class="card">
                    <h3>
                        Agosto
                    </h3>
